<template>
  <main class="py-32 px-12 font-light">
    <div class="page">
      <div class="header">
        <div class="container mb-4">
          <p class="text-3xl font-bold">
            Privacy Policy for جواز السفر العراقي الالكتروني
          </p>
        </div>
      </div>
      <div>
        <div class="container">
          <div
            class="flex flex-col gap-4 [&>ul]:list-disc [&>h1]:text-2xl [&>h2]:text-xl [&>ul]:text-lg text-lg leading-8 text-justify">
            <p class="mb-8">Last updated: December 16, 2022</p>
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Application</strong> refers to جواز السفر العراقي
                  الالكتروني, the software program provided by the Company.
                </p>
              </li>
              <li>
                <p>
                  <strong>Company</strong> (referred to as either "the Company",
                  "We", "Us" or "Our" in this Agreement) refers to جواز السفر
                  العراقي الالكتروني.
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>By email: media@moi.gov.iq</p>
              </li>
              <li>
                <p>
                  By visiting this page on our website:
                  <a
                    href="https://epp.lab-logic.com/contact"
                    rel="external nofollow noopener"
                    target="_blank"
                    >https://epp.lab-logic.com/contact</a
                  >
                </p>
              </li>
            </ul>
